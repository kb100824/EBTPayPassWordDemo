...
@end
@implementation EBTPayPassWordView
+ (EBTPayPassWordView *)shareInstance
{
    static EBTPayPassWordView *myInstance = nil;
    static dispatch_once_t onceToken;
   dispatch_once(&onceToken, ^{
       
       myInstance = [[EBTPayPassWordView alloc]init];
...
+ (void)showPassWordViewInView:(CompleteHandler)completeHandler
{
    [[EBTPayPassWordView shareInstance] showPassWordViewInView:completeHandler];
}
/**显示对话框*/
